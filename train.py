...
def train_model(model, EPOCHS, train_iterator, optimizer, criterion, scheduler, device):
...
if __name__ == '__main__':
    ...
    train_data, test_data = make_train_test(image_dir, train_dir, test_dir, flag=True)
    ...
    best_model_path = train_model(model, EPOCHS, train_iterator, optimizer, criterion, scheduler, device)
    # best_model_path = train_model(model, EPOCHS, train_iterator, valid_iterator, optimizer, criterion, scheduler, device)
